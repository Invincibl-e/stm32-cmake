...
if ( ${STM32Cube_FOUND} )
	...
	if ( NOT STM32HAL_INCLUDE )
		message ( FATAL_ERROR "The ${STM32Cube}/Drivers/STM32${STM32_SERIES}xx_HAL_Driver/Inc/stm32${STM32_SERIES_LOWERCASE}xx_hal.h can not found in ${STM32Cube}/Drivers/STM32${STM32_SERIES}xx_HAL_Driver/Inc/, please try to fix ${STM32Cube} package." )
	endif ()
	...
	if ( IS_DIRECTORY "${STM32HAL_SOURCE_DIR}" )
		...
		message ( FATAL_ERROR "${STM32HAL_SOURCE_DIR} not found, please try to fix ${STM32Cube} package." )
	endif ()
else ()
