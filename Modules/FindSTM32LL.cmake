...
if ( ${STM32Cube_FOUND} )
	...
	if ( NOT STM32LL_INCLUDE )
		message ( FATAL_ERROR "The ${STM32Cube}/Drivers/STM32${STM32_SERIES}xx_HAL_Driver/Inc can not found, please try to fix ${STM32Cube} package." )
	endif ()

	stm32_find ( STM32LL_SOURCE_DIR "${STM32Cube}/Drivers/STM32${STM32_SERIES}xx_HAL_Driver/Src/stm32${STM32_SERIES_LOWERCASE}xx_ll_gpio.c" DIRECTORY )
	if ( NOT STM32LL_SOURCE_DIR )
