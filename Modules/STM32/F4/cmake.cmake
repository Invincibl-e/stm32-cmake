...
if ( ${STM32Cube_FOUND} AND ${CMSIS_FOUND} )
	...
	if ( NOT EXISTS ${PROJECT_SOURCE_DIR}/${STM32_STARTUP_SOURCE_NAME} )
		...
		configure_file ( ${STM32_STARTUP_SOURCE} ${PROJECT_SOURCE_DIR}/${STM32_STARTUP_SOURCE_NAME} COPYONLY )
	...
	set ( STM32_SOURCE_FILES ${STM32_SOURCE_FILES} ${PROJECT_SOURCE_DIR}/${STM32_STARTUP_SOURCE_NAME} ${PROJECT_SOURCE_DIR}/system_stm32${STM32_SERIES_LOWERCASE}xx.c )
