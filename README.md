...
* `STM32_STDLIB` - If defined, will generate a syscalls.c to your ${PROJECT_SOURCE_DIR}. default: `--specs=nosys.specs`.( [Documentation](https://launchpadlibrarian.net/287100883/readme.txt) )
